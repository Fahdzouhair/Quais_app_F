sap.ui.define([
    ...
    return Controller.extend("sd17appquaisvf.controller.Quais", {
        onInit() {
                    ...
                    oModel.read("/ZCDS_QUAIS_STND", {
                        ...
                        success: function(oDataStockQuais) {
                            ...
                            aNewEntries.forEach(function(oNewEntry) {
                                oModel.create("/ZCDS_QUAIS_SPE", oNewEntry, {
                                    success: function() {
        ...
        onValueHelpRequest: function (oEvent) {
            ...
            if (sInputId.indexOf("filtreCodeArticle") !== -1) {
                if (!this._oProductVHDialog) {
                    this._oProductVHDialog = sap.ui.xmlfragment("sd17appquaisvf.fragments.ProductVHDialog", this);
                ...
                if (!this._oPlantVHDialog) {
                    this._oPlantVHDialog = sap.ui.xmlfragment("sd17appquaisvf.fragments.PlantVHDialog", this);
                ...
                if (!this._oMagasinVHDialog) {
                    this._oMagasinVHDialog = sap.ui.xmlfragment("sd17appquaisvf.fragments.MagasinVHDialog", this);
